...
Page({
  ...
  onLoad: function (options) {
    var that = this;
    app.getPageData("BoxApi/Subject/timeline",{'user_id':1,'type':'ask'},function(data){
         if(data.pager){
  ...
  scrolltolower:function(e){
    ...
    if(totalPages>nowPage){
        nowPage=nowPage+1;
        app.getPageData("BoxApi/Subject/timeline",{'user_id':1,'p':nowPage,'type':'ask'},function(data){
          if(data.list){
